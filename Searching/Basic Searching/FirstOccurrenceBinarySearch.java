/*
A java program to search the first occurrence of target element in the given sorted array using binary Search
LOGIC : 
...
when target found, store mid and move left to find the first occurrence
*/
...
public class FirstOccurrenceBinarySearch{
    public static void main(String[] args){
        ...
        while(low<=high){
           mid=low + (high-low)/2;
           if(arr[mid]==key) {
            //to find the first occurrence store mid and move left
              idx= mid;
              high=mid-1;
              continue;
            }
        ...
        System.out.println("Target element not found!");
            ...
            System.out.println("First occurrence of target element is at index "+idx);
        }
        sc.close();
    }
...
First occurrence of target element is at index 3
