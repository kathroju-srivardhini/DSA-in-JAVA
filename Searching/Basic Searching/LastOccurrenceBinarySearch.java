/*
A java program to search the last occurrence of target element in the given sorted array using binary Search
LOGIC : 
...
when target found, store mid and move right to find the last occurrence
*/
...
public class LastOccurrenceBinarySearch{
    public static void main(String[] args){
        ...
        while(low<=high){
           mid=low + (high-low)/2;
           if(arr[mid]==key) {
            //to find the last occurrence store mid and move right
              idx= mid;
              low=mid+1;
              continue;
            }
        ...
        System.out.println("Target element not found!");
            ...
            System.out.println("Last occurrence of target element is at index "+idx);
        }
        sc.close();
    }
...
Last occurrence of target element is at index 5
